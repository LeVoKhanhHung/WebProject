      ...
      <div class="register-box">
        ...
        <form action="../checkRegister" method="GET">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" name="fullName" placeholder="Nhập họ và tên của bạn">
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="phone" name="phoneNumber" placeholder="Nhập số điện thoại của bạn">
          </div>
        ...
        <div class="text-center mt-3">
          ...
          <p><a href="#">Tạo tài khoản để có thể đăng tin miễn phí</a></p>
        </div>
      </div>
    </div>
  </div>
